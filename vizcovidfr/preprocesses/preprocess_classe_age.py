...
def covid_day_fct(T):
    '''
    Groupby the dataframe by day, summing others columns and add column from index.
    :param T: classe_age dataframe.
    :type T: Pandas dataframe
    :return: sub-dataframe of 'classe_age'
    :rtype: Pandas dataframe
...
def dico_file():
    ...
    :rtype: dict
    '''
    dico_file = {1:'hospitalization', 2:'reanimation', 3:'hosp_conv', 4:'SSR_USLD', 5:'others', 6:'back_home', 7:'deaths'}
    return dico_file
...
def rmse_list(x, y):
    '''
    Give the list of mean squared error, x predicted and y predicted depending of polynom degree.
    :param x: abscissa of points we want to predict
    :type x: list
    :param y: ordonate of points we want to predict
    :type y: list
